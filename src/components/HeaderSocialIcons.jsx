 ...
 * Compact horizontal social media icons for header
 * Displays Facebook, Instagram, YouTube, WhatsApp in a row
 */
const HeaderSocialIcons = () => {
  ...
  return (
    <div className="flex gap-2 items-center" role="list" aria-label="Social media links">
      {socialLinks.map((social, index) => (
        ...
        >
          ...
          <div
            className="absolute -bottom-10 left-1/2 -translate-x-1/2 px-3 py-1 rounded-md text-xs font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none z-50"
            style={{
              background: isDark
                ? 'linear-gradient(135deg, rgba(10, 42, 67, 0.95), rgba(15, 60, 87, 0.98))'
              ...
              boxShadow: isDark
                ? '0 4px 12px rgba(0, 0, 0, 0.3), 0 0 8px rgba(255, 215, 0, 0.2)'
                : '0 4px 12px rgba(0, 0, 0, 0.1), 0 0 8px rgba(184, 134, 11, 0.2)'
            }}
          >
            {social.name}
            {/* Tooltip Arrow */}
